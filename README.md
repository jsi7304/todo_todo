...
<ol>
  ...
  <h4><p><li>Redux toolkit thunk state 관리에 관한 문제</li></p></h4>
    <p><h5>개요</h5>- response data가 즉시 반영되지 않는 문제가 발생</p>
  <p><h5>해결과정</h5>- response data가 단순 메세지 형식으로 오는 것을 확인</p>
  <p><h5>해결</h5>-get 요청을 한번 더 실행하여 해결</p>
</ol>
